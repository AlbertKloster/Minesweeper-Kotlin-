...
<b>Example 1:</b> <i>the user loses after exploring a cell that contains a mine</i>
```
...
<b>Example 2:</b> <i>the user wins by marking all mines correctly</i>
```
...
<b>Example 3:</b> <i>the user wins by exploring all safe cells</i>
```
